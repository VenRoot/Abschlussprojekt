...
async function Serverlobby()
{
  let UnoTable = document.getElementById("UnoTable");
  UnoTable
}
...
{
  switch (belegt2) {
    case 1: dat("UPDATE INUSE SET Server1 = FALSE;"); break;
    case 2: dat("UPDATE INUSE SET Server2 = FALSE;"); break;
    case 3: dat("UPDATE INUSE SET Server3 = FALSE;"); break;
    case 4: dat("UPDATE INUSE SET Server4 = FALSE;"); break;
    case 5: dat("UPDATE INUSE SET Server5 = FALSE;"); break;
...
async function setName()
{
  ...
  {
    alert("Bitte nicht die selben Namen verwenden");
  }
    else {
      $("#Namenn").hide();
      await OpenUno();
